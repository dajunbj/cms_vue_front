        ...
        <el-row :gutter="20">
          <el-col :span="10">
            <el-form-item label="姓名" prop="name">
              <el-input v-model="form.name" readonly class="el-input-disabled"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="10">
        ...
        <el-row :gutter="20">
          <el-col :span="10">
            <el-form-item label="社員タイプ" prop="employee_type">
              <el-select v-model="form.employee_type" readonly class="el-input-disabled">
        ...
        <el-row :gutter="20">
          <el-col :span="10">
            <el-form-item label="社員電話番号" prop="phone_number">
              <el-input v-model="form.phone_number" readonly class="el-input-disabled"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="10">
          ...
          <el-col :span="10">
            <el-form-item label="契約開始日" prop="start_date">
              <el-date-picker
                ...
                type="date"
                readonly class="el-input-disabled"
                style="width: 100%;"
              ></el-date-picker>
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="20">
          <el-col :span="10">
            <el-form-item label="単価" prop="unit_price">
              <el-input v-model="form.unit_price" readonly class="el-input-disabled"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="10">
            <el-form-item label="税率" prop="tax_rate">
              <el-input v-model="form.tax_rate" readonly class="el-input-disabled"></el-input>
            </el-form-item>
          </el-col>
        ...
        <el-row :gutter="20">
          <el-col :span="10">
            <el-form-item label="最低勤務時間" prop="working_hours_min">
              <el-input v-model="form.working_hours_min" readonly class="el-input-disabled"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="10">
            <el-form-item label="最大勤務時間" prop="working_hours_max">
              <el-input v-model="form.working_hours_max" readonly class="el-input-disabled"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20">
          <el-col :span="10">
            <el-form-item label="最大残業時間" prop="overtime_limit_hours">
              <el-input v-model="form.overtime_limit_hours" readonly class="el-input-disabled"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
        ...
        <el-row :gutter="20" v-if="form.overtime_included===1">
          <el-col :span="10">
            <el-form-item label="残業代開始時間" prop="overtime_start_time">
              <el-input v-model="form.overtime_start_time" readonly class="el-input-disabled"></el-input>
            </el-form-item>
          </el-col>
        </el-row>
